...
KBlock *KInstruction::getKBlock() const { return parent; }
KFunction *KInstruction::getKFunction() const { return getKBlock()->parent; }
KModule *KInstruction::getKModule() const { return getKFunction()->parent; }
