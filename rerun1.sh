...
./default_build.sh
rm -rf /tmp/klee-out/
/home/columpio/klee_build/klee_build110z3/bin/klee \
  ...
  --analysis-reproduce=/home/columpio/tmp/evaluation/flite/2_without_first_event_with_return.sarif \
  /home/columpio/tmp/evaluation/flite/input.bc &> ~/Desktop/test1.log
